...
export interface ApiAgentProfileAgentProfile extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contact_details: Attribute.JSON;
    working_hours: Attribute.JSON;
...
export interface ApiAgentTypeAgentType extends Schema.CollectionType {
  collectionName: 'agent_types';
  info: {
    singularName: 'agent-type';
  ...
  attributes: {
    type: Attribute.Enumeration<['Solo', 'PartOfOrg']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::agent-type.agent-type',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiOrganizationMemberOrganizationMember
  ...
  attributes: {
    ...
    >;
    role: Attribute.Enumeration<['Owner', 'Agent']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiUserTypeUserType extends Schema.CollectionType {
  ...
  attributes: {
    type: Attribute.Enumeration<['Business', 'Private']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::agent-type.agent-type': ApiAgentTypeAgentType;
